...
const ProfileForm = () => {
  ...
  return (
    <div className="profile-card-container">
      <div className="profile-card-title">Your Profile</div>
      {editMode ? (
        <form onSubmit={handleSubmit} className="profile-card-details">
          <label>
            Name
            <input
              type="text"
          ...
          <div className="profile-card-actions">
            <button type="submit" className="profile-card-btn">Save</button>
            <button type="button" className="profile-card-btn cancel" onClick={() => setEditMode(false)}>Cancel</button>
          </div>
        </form>
      ) : (
        <div className="profile-card-details">
          ...
          <div className="profile-card-actions">
            <button onClick={handleEdit} className="profile-card-btn">Edit</button>
          </div>
        </div>
      )}
    </div>
